...
| California Housing | RMSLE (↓) | 0.1978 | 0.1834 |
...
| California Housing | RMSLE (↓) | 0.2012 | 0.1856 |
...
| California Housing | RMSLE (↓) | 0.2134 | 0.1989 | 0.1967 | 0.1912 | — |
...
| Detecting Insults | AUC (↑) | 0.7789 | 0.7512 | 0.7623 | 0.7745 | — |
...
| California Housing | RMSLE (↓) | 0.2456 | 0.2234 | 0.2178 | 0.2089 | — |
...
| California Housing | RMSLE (↓) | 0.2089 | 0.1989 | 0.1978 | 0.1956 | — |
| Leaf Classification | Log Loss (↓) | 0.0667 | 0.0512 | 0.0498 | 0.0467 | — |
| Aerial Cactus | Accuracy (↑) | 0.9982 | 0.9980 | 0.9981 | 0.9983 | — |
| Denoising Documents | MSE (↓) | 0.0098 | 0.0103 | 0.0101 | 0.0096 | — |
| Detecting Insults | AUC (↑) | 0.8034 | 0.7734 | 0.7834 | 0.7956 | — |
...
- **Image tasks** (Aerial Cactus, Denoising): Negligible impact — these tasks rely on CNN/ResNet architectures where skrub adds no value.
...
- Average gap: hybrid RAG achieves **+1-3%** better task-level scores than naive RAG across models, with the largest gains on text tasks and diminishing returns on pure tabular tasks.
...
- **Detecting Insults**: Small competition (50 teams) with AUC metric. Proprietary models medal in Default (GPT-4o: gold, Gemini: silver). Skrub causes regression across all models; for open-weight models, hybrid RAG recovers Detecting Insults to bronze (Qwen3, Llama) by providing better encoder guidance.
